...
public class addCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Add a new Customer:");

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Fill up the follwing data to add a new customer to the database");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String SQL = "INSERT INTO `addcustomer` (`firstname`, `lastname`, `nic`, `passport`, `address`, `dob`, `gender`, `contact`, `photo`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
